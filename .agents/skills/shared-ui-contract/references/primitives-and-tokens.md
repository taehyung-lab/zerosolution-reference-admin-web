...
Read this file only for a shadcn-style copied component, Radix primitive, Tailwind token/variant, focus, keyboard behavior, primitive accessibility, or React rendering/compiler questions. The public contract of each primitive is a row in [catalog.md](catalog.md#primitives).
