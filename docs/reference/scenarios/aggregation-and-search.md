...
| 결과별 table·paging | list mechanic은 Router/Query를 읽지 않는 shared surface를 조립 | 커버됨 — [list-workflow.md](../../../.agents/skills/feature-contract/references/list-workflow.md):67-74 |
