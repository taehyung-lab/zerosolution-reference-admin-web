...
export const CASES = [
  ...
  { fixture: 'folders/mechanic-imports-screen.ts', target: 'src/features/gate-a/mechanics/selection/model/screen-negative.ts', expectedRule: 'import-x/no-restricted-paths' },
