...
export const CASES = [
  ...
  { id: 'collection/재표현', request: '폼 안에서 행을 추가·삭제하는 반복 입력을 만들어주세요.', expect: ['collection-contract'], allow: ['form-contract'], reject: ['list-contract'] },
  ...
  { id: 'route/재표현', request: '주소로 바로 열었을 때 데이터가 먼저 로드되게 해주세요.', expect: ['route-composition'], allow: ['server-state'], reject: ['form-contract'] },
  ...
  { id: 'screen-composition/재표현', request: '새 화면 하나를 route 와 feature 로 어떻게 나눠야 하나요.', expect: ['screen-composition'], allow: ['source-structure'], reject: ['detail-contract'] },
  ...
  { id: 'specialized/재표현', request: '통계 보드에서 축을 바꾸면 셀이 다시 계산돼야 합니다.', expect: ['specialized-screens'], allow: ['server-state'], reject: ['form-contract'] },
  ...
  { id: 'auth/재표현', request: '401 이 오면 어디서 처리하고 있나요.', expect: ['auth-session'], allow: ['api-wire'], reject: ['list-contract'] },
