...
const resources: Record<UiLocale, Record<AppI18nNamespace, object>> = {
  ko: { app: koApp, auth: koAuth, community: koCommunity, managers: koManagers, members: koMembers, messaging: koMessaging, performances: koPerformances },
  en: { app: enApp, auth: enAuth, community: enCommunity, managers: enManagers, members: enMembers, messaging: enMessaging, performances: enPerformances },
  ja: { app: jaApp, auth: jaAuth, community: jaCommunity, managers: jaManagers, members: jaMembers, messaging: jaMessaging, performances: jaPerformances },
}
