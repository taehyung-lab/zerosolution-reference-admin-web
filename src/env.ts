 ...
 *
 * 신규 제품의 실제 배포 환경은 미확인이다(제품 사실은 docs/reference/product.json 이 연결한다). 여기에 특정 호스트를
 ...
 * TRANSPLANT_PENDING_API_BASE: `/api` 접미 검증은 리허설 endpoint prefix 전제다. 신규 OpenAPI의 base path에 맞게 재판정한다.
 */
