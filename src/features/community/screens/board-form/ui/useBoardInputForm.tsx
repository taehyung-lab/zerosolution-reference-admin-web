 ...
 * 섹션은 접히지 않는 하나뿐이라 `useFormSections` 의 오류 펼치기가 필요하지 않다.
 */
...
export function useBoardInputForm({
  ...
  const form = useForm({
    ...
    onSubmit: ({ value }) => confirmation.requestConfirmation(boardFormSchema.parse(value)),
