...
export const managerKeys = {
  ...
  detail: (locale: string, id: string) =>
    [...managerKeys.all(locale), 'detail', id] as const,
  editDetail: (locale: string, id: string) =>
    [...managerKeys.all(locale), 'edit-detail', id] as const,
  typeOptions: (locale: string) =>
    [...managerKeys.all(locale), 'type-options'] as const,
  ...
  agencyOptions: (locale: string) =>
    [...managerKeys.all(locale), 'agency-options'] as const,
};
