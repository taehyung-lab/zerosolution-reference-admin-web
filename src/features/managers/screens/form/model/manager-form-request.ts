...
} from "../../../api/manager-form-contract";
...
function agencyId(
  type: ManagerCreateRequest["type"],
  value: string,
): number | undefined {
...
export function toManagerCreateRequest(
  values: ManagerCreateValues,
): ManagerCreateRequest {
 ...
 */
export function toManagerUpdateRequest(
