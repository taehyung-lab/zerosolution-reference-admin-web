...
import type { useMemberAccessListResult } from "./useMemberAccessListResult";
export function MemberAccessListResult({
  data,
  searched,
  result,
  toolbarRight,
  ...
  readonly result: ReturnType<typeof useMemberAccessListResult>;
