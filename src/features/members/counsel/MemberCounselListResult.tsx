...
import type { useMemberCounselListResult } from "./useMemberCounselListResult";
import type { MemberRecordSearch } from "../records/member-record-search";

export function MemberCounselListResult({
  data,
  result,
  search,
  onSearchChange,
  ...
  readonly result: ReturnType<typeof useMemberCounselListResult>;
