...
import { memberActivityQuery } from '../../api/detail-queries';
import type { MemberActivitySearch } from './MemberActivitySection';

export function useMemberActivity(memberId: string, search: MemberActivitySearch) {
